  ...
  slideItems = [
    {
      title: 'Student',
      detail:
        'As a student, you can do your homework, take tests and find the necessary resources for this.',
    },
    {
      title: 'Teacher',
      detail:
        'Set up activities for your students, like as tests, homework, and resources to help them.',
    },
    {
      title: 'Administrative',
      detail:
        'Organize the schedules, classes and other things of the institute. You are the boss.',
    },
  ];
